...
//------------------------------------------------------------------------------
/** create an instance of WaveBit. */
WaveBit::WaveBit(void) {
  fd = 0;
}
//------------------------------------------------------------------------------
/**
 ...
 *  file with features that WaveBit does not support.
 */
uint8_t WaveBit::create(FatReader &f)
{
  // 18 byte buffer
 ...
 * Play a wave file.
 *
 * WaveBit::create() must be called before a file can be played.
 *
 * Check the member variable WaveBit::isplaying to monitor the status
 * of the player.
 */
void WaveBit::play(void) {
 ...
 */
int16_t WaveBit::readWaveData(uint8_t *buff, uint16_t len) {
 ...
 */
void WaveBit::seek(uint32_t pos)
{
 ...
 */
void WaveBit::setSampleRate(uint32_t samplerate) 
{
